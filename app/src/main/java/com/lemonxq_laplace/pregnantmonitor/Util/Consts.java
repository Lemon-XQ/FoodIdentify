...
public class Consts {
    ...
    public static String URL_Update = URL + "update.json";
    public static String URL_FoodIdentify = URL + "FoodIdentifyServlet";
    ...
    public static String SUCCESSCODE_FOODIDENTIFY = "107";
