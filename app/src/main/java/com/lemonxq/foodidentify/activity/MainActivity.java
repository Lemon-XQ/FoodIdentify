...
import com.lemonxq.foodidentify.Data.User;
import com.lemonxq.foodidentify.R;
import com.lemonxq.foodidentify.view.ToolBar;
import com.lemonxq.foodidentify.Util.ACache;
import com.lemonxq.foodidentify.Util.ActivityController;
import com.lemonxq.foodidentify.Util.CommonRequest;
import com.lemonxq.foodidentify.Util.CommonResponse;
import com.lemonxq.foodidentify.Util.Consts;
import com.lemonxq.foodidentify.Util.Database;
import com.lemonxq.foodidentify.Util.HttpUtil;
import com.lemonxq.foodidentify.Util.PhotoUtil;
import com.lemonxq.foodidentify.Util.Server;
import com.lemonxq.foodidentify.Util.SharedPreferencesUtil;
import com.lemonxq.foodidentify.Util.UserManager;
import com.lemonxq.foodidentify.Util.Util;
import com.lemonxq.foodidentify.fragment.DateDialogFragment;
import com.lemonxq.foodidentify.fragment.MonitorFragment;
import com.lemonxq.foodidentify.fragment.ToolFragment;
...
public class MainActivity extends BaseActivity implements DialogInterface.OnDismissListener{
    ...
    private int[] bottomPic = {R.drawable.icon_monitor,R.drawable.icon_toolbox};
        ...
        photoUtil.setOnPhotoResultListener(new PhotoUtil.OnPhotoResultListener() {
            ...
            public void onPhotoResult(final Uri uri) {
                if (uri != null && !TextUtils.isEmpty(uri.getPath())) {
                    ...
                    HttpUtil.uploadImage(Consts.URL_UploadImg,"avatar",bitmap,new okhttp3.Callback(){
                        @Override
    ...
    void initData(){
        ...
        if(user.isVisitor()){
            ...
            if(nickname != null || ((nickname = server.getNickname()) != null && !nickname.equals("null"))){
                Log.e("INIT",nickname);
                user.setNickname(nickname);
                user.save();
            }else {
        ...
        builder = AllenVersionChecker
                ...
                .request(new RequestVersionListener() {
                    ...
                    public UIData onRequestVersionSuccess(String result) {
                        ...
                        // 服务端版本大于本地版本时才进行更新
                        if(versionCode <= Util.getLocalVersionCode(MainActivity.this)) return null;
                        return UIData
                                .create()
